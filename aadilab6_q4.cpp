...
//finding the sum and then the minimum number by value
int func(int a , int b){
	// it takes the value of c and d directly then finds the sum of two and then finds the minimum among them
	int sum = a + b;
	//this condition finds the max value
	cout<<"the min of the two is ";
	if(a<b){
		cout<<a;
		}
	else{
...
//finding the sum and then the minimum value by reference
